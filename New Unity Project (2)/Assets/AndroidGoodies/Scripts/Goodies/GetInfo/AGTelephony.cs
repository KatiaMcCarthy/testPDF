...
namespace DeadMosquito.AndroidGoodies
{
	...
	public static class AGTelephony
	{
		...
		public static SimStates SimState
		{
			get
			{
				if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.O))
				{
		...
		public static string TelephonyDeviceId
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getDeviceId");
			}
		}
		...
		public static string TelephonySimSerialNumber
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getSimSerialNumber");
			}
		}
		...
		public static List<CellInfo> AllCellInfo
		{
			get
			{
				if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.JELLY_BEAN_MR1))
				{
					return new List<CellInfo>();
				}
				
				var result = new List<CellInfo>();
				var cellsListAjo = AGSystemService.TelephonyService.CallAJO("getAllCellInfo");
		...
		public static NetworkTypes DataNetworkType
		{
			get
			{
				if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.N))
				{
					return NetworkTypes.Unknown;
				}
				
				return (NetworkTypes) AGSystemService.TelephonyService.CallInt("getDataNetworkType");
			}
		}
		...
		public static DataConnectionStates DataState
		{
			get
			{
				...
				return (DataConnectionStates) AGSystemService.TelephonyService.CallInt("getDataState");
			}
		}
		...
		public static string DeviceId
		{
			get
			{
				if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.M))
				{
					return string.Empty;
				}
		...
		public static string DeviceSoftwareVersion
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getDeviceSoftwareVersion");
			}
		}
		...
		public static string GroupIdLevel1
		{
			get
			{
				if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.JELLY_BEAN_MR2))
				{
					return string.Empty;
				}

				return AGSystemService.TelephonyService.CallStr("getGroupIdLevel1");
			}
		}
		...
		public static string IMEI
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getImei");
			}
		}
		...
		public static string Line1Number
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getLine1Number");
			}
		}
		...
		public static string MEID
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getMeid");
			}
		}
		...
		public static string MmsUaProfUrl
		{
			get
			{
				if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.KITKAT))
				{
					return string.Empty;
				}

				return AGSystemService.TelephonyService.CallStr("getMmsUAProfUrl");
			}
		}
		...
		public static string MmsUserAgent
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getMmsUserAgent");
			}
		}
		...
		public static string Nai
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getNai");
			}
		}
		...
		public static string NetworkOperator
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getNetworkOperator");
			}
		}
		...
		public static string NetworkOperatorName
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getNetworkOperatorName");
			}
		}
		...
		public static string NetworkSpecifier
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getNetworkSpecifier");
			}
		}
		...
		public static NetworkTypes NetworkType
		{
			get
			{
				...
				return (NetworkTypes) AGSystemService.TelephonyService.CallInt("getNetworkType");
			}
		}
		...
		public static int PhoneCount
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallInt("getPhoneCount");
			}
		}
		...
		public static PhoneTypes PhoneType
		{
			get
			{
				...
				return (PhoneTypes) AGSystemService.TelephonyService.CallInt("getPhoneType");
			}
		}
		...
		public static ServiceStates ServiceState
		{
			get
			{
				if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.O))
				{
					return new ServiceStates();
				}

				return new ServiceStates(AGSystemService.TelephonyService.CallAJO("getServiceState"));
			}
		}
		...
		public static SignalStrengths SignalStrength
		{
			get
			{
				...
				return new SignalStrengths(AGSystemService.TelephonyService.CallAJO("getSignalStrength"));
			}
		}
		...
		public static int SimCarrierId
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallInt("getSimCarrierId");
			}
		}
		...
		public static string SimCarrierIdName
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getSimCarrierIdName");
			}
		}
		...
		public static string SimCountryIso
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getSimCountryIso");
			}
		}
		...
		public static string SimOperator
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getSimOperator");
			}
		}
		...
		public static string SimOperatorName
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getSimOperatorName");
			}
		}
		...
		public static string SubscriberId
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getSubscriberId");
			}
		}
		...
		public static string VisualVoicemailPackageName
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getVisualVoicemailPackageName");
			}
		}
		...
		public static string VoiceMailAlphaTag
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getVoiceMailAlphaTag");
			}
		}
		...
		public static string VoiceMailNumber
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallStr("getVoiceMailNumber");
			}
		}
		...
		public static NetworkTypes VoiceNetworkType
		{
			get
			{
				...
				return (NetworkTypes) AGSystemService.TelephonyService.CallInt("getVoiceNetworkType");
			}
		}
		...
		public static bool HasCarrierPrivileges
		{
			get
			{
				if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.LOLLIPOP_MR1))
				{
					return false;
				}
		...
		public static bool HasIccCard
		{
			get
			{
				if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.ECLAIR))
				{
					return false;
				}
		...
		{
			if (AGUtils.IsNotAndroidCheck() || !Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.LOLLIPOP))
			{
				return;
			}
		...
		public static IccOpenLogicalChannelResponse IccOpenLogicalChannel(string appId)
		{
			...
			return new IccOpenLogicalChannelResponse(AGSystemService.TelephonyService.CallAJO("iccOpenLogicalChannel", appId));
		}
		...
		public static IccOpenLogicalChannelResponse IccOpenLogicalChannel(string appId, int p2)
		{
			...
			return new IccOpenLogicalChannelResponse(AGSystemService.TelephonyService.CallAJO("iccOpenLogicalChannel", appId, p2));
		}
		...
		public static string IccTransmitApduBasicChannel(int cla, int instruction, int p1, int p2, int p3, string data)
		{
			...
			return AGSystemService.TelephonyService.CallStr("iccTransmitApduBasicChannel", cla, instruction, p1, p2, p3, data);
		}
		...
		public static string IccTransmitApduLogicalChannel(int channelId, int cla, int instruction, int p1, int p2, int p3, string data)
		{
			...
			return AGSystemService.TelephonyService.CallStr("iccTransmitApduLogicalChannel", channelId, cla, instruction, p1, p2, p3, data);
		}
		...
		public static bool IsWorldPhone
		{
			get
			{
				...
				return AGSystemService.TelephonyService.CallBool("isWorldPhone");
			}
		}
		...
		public static string SendEnvelopeWithStatus(string content)
		{
			...
			return AGSystemService.TelephonyService.CallStr("sendEnvelopeWithStatus", content);
		}
		...
		public static void SetLine1NumberForDisplay(string alphaTag, string number)
		{
			...
			AGSystemService.TelephonyService.CallBool("setLine1NumberForDisplay", alphaTag, number);
		}
		...
		public static void SetNetworkSelectionModeManual(string operatorNumeric, bool persistSelection)
		{
			...
			AGSystemService.TelephonyService.CallBool("setNetworkSelectionModeManual", operatorNumeric, persistSelection);
		}
		...
		public static void SetOperatorBrandOverride(string brand)
		{
			...
			AGSystemService.TelephonyService.CallBool("setOperatorBrandOverride", brand);
		}
		...
		public static void SetPreferredNetworkTypeToGlobal()
		{
			...
			AGSystemService.TelephonyService.CallBool("setPreferredNetworkTypeToGlobal");
		}
