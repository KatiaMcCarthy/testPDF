...
namespace DeadMosquito.AndroidGoodies
{
	...
	public static class AGUIMisc
	{
		...
		public static void ChangeApplicationIconState(bool show)
		{
			...
			{
				AGUtils.PackageManager.Call("setComponentEnabledSetting", componentName, show ? (int) ComponentEnabledState.Enabled : (int) ComponentEnabledState.Disabled, DoNotKillAppFlag);
			}
		}
	}
}
