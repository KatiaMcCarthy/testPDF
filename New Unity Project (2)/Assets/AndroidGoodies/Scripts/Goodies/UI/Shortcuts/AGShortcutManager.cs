...
namespace DeadMosquito.AndroidGoodies.Internal
{
	...
	public static class AGShortcutManager
	{
		...
		public static void RequestPinShortcut(ShortcutInfo shortcut)
		{
			...
			var pendingIntentSender = AndroidPendingIntent.GetActivity(intent.AJO).CallAJO("getIntentSender");
		...
		{
			get { return !AGUtils.IsNotAndroidCheck() && Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.N_MR1); }
		}
	}
}
