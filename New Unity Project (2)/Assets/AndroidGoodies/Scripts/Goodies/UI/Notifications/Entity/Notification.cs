	...
	public class Notification
	{
		...
		public class Builder
		{
			...
			void SetOpenThisApp(Dictionary<string, string> customData)
			{
				...
				_builderAjo.CallAJO("setContentIntent", AndroidPendingIntent.GetActivity(androidIntent.AJO));
			}
		...
		public class Action
		{
			...
			public class Builder
			{
				...
				public Builder(int icon, string title, AndroidIntent intent)
				{
					...
					if (!Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.KITKAT_WATCH))
					{
		...
		public class BigTextStyle
		{
			...
			public BigTextStyle()
			{
				...
				if (!Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.JELLY_BEAN))
				{
